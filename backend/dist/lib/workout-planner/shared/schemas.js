...
exports.planResponseSchemaText = exports.workoutPlanSchema = exports.workoutRequestSchema = exports.DEFAULT_EQUIPMENT = void 0;
exports.isWorkoutPlan = isWorkoutPlan;
exports.DEFAULT_EQUIPMENT = ['barbell', 'dumbbell', 'machines', 'bands', 'bodyweight'];
exports.workoutRequestSchema = {
    type: 'object',
...
exports.planResponseSchemaText = JSON.stringify(exports.workoutPlanSchema);
function isWorkoutPlan(value) {
    if (!value || typeof value !== 'object') {
        return false;
    }
    const plan = value;
    return (typeof plan.planName === 'string' &&
